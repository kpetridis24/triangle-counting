...
u_int32_t cooReader(char* name, u_int32_t* I, u_int32_t* J, u_int32_t* II, u_int32_t* JJ){
    ...
    I = (u_int32_t *) malloc(nz * sizeof(u_int32_t));
    J = (u_int32_t *) malloc(nz * sizeof(u_int32_t));
...
u_int32_t *V4_cilk(u_int32_t *row, u_int32_t *col, u_int32_t N){

    int tr = 0;
    u_int32_t *c3 = (u_int32_t *)calloc(N, sizeof(u_int32_t));
